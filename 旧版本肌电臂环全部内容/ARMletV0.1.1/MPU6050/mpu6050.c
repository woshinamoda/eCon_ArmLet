...
uint8_t Imu_Data_Sent[30]={0x66,0xBB,0xcc,0xdd};
...
{
//Imu_Data_Sent
	Imu_Data_Sent[4] =((short)(Pitch*100))>>8;
	Imu_Data_Sent[5] =((short)(Pitch*100))&0x00ff;
	Imu_Data_Sent[6] =((short)(Roll*100))>>8;
	Imu_Data_Sent[7] =((short)(Roll*100))&0x00ff;
	Imu_Data_Sent[8] =((short)(Yaw*100))>>8;
	Imu_Data_Sent[9] =((short)(Yaw*100))&0x00ff;
}
#endif
