...
uint8_t Imu_Data_Sent[10]={0x66,0xBB};
...
void IMU_Data_Send()
{
	Imu_Data_Sent[2] =((short)(Pitch*100))>>8;
	Imu_Data_Sent[3] =((short)(Pitch*100))&0x00ff;
	Imu_Data_Sent[4] =((short)(Roll*100))>>8;
	Imu_Data_Sent[5] =((short)(Roll*100))&0x00ff;
	Imu_Data_Sent[6] =((short)(Yaw*100))>>8;
	Imu_Data_Sent[7] =((short)(Yaw*100))&0x00ff;
	
//	Imu_Data_Sent[9] = 0;															//每次校验前刷新清0
//	for(int i=3;i<9;i++)
//	{
//		Imu_Data_Sent[i]=Calculate[i-2];
//		Imu_Data_Sent[9] += Imu_Data_Sent[i];						//15是对应数据和最低位
//	}		
